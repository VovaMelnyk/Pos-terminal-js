  ...
  <div class="card horizontal">
    ...
    addToScreen(container, position, element) {
     ...
     addListeners() {
      ...
      start(container) {
        this.addToScreen(container, "beforeend", this.renderNewCategoryIngredient());
        this.addListeners();
      }
    }

    const newCategoryIngredient = new NewCategoryIngredient();
    newCategoryIngredient.start(root);